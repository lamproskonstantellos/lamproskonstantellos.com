...
defineArticle({
  ...
  body: [
    ...
    "• **Grid capacity is becoming the central constraint.** Renewable deployment, electrification, storage, and new demand from data centres all depend on how quickly transmission and distribution infrastructure can be reinforced, digitalised, and operated with greater visibility.",
