...
defineArticle({
  slug: "renewable-energytech-expo-thessaloniki",
  date: "2026-03-28",
  ...
  sources: [
    { label: "Renewable EnergyTech",       href: "https://www.renewable-energytech-expo.gr" },
    { label: "Earlier interview (Greek)",  href: "https://paidiapaphol.gr/labros-konstantellos-o-neos-pou-protoporei-kainotomei-kai-provallei-tin-poli-mas/" },
  ],
});
