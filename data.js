  ...
  news: [
    {
      ...
      photos: [],
      body: [
        "On 6–7 April 2026, I attended the **7th Power & Gas Forum** in Athens, organised by **energypress**. The forum focused on the changing structure of the Greek electricity and gas markets, with discussions around grid development, system adequacy, flexibility, storage, gas infrastructure, retail market evolution, and the growing impact of large electricity consumers such as data centers.",
    ...
    },
    {
      ...
      body: [
        "From 8–10 October 2025, I attended the **IEEE Power and Energy Student Summit (PESS) 2025** at the **Technical University of Munich**. The summit brought together students, researchers, and engineers working on smart grids, renewable energy systems, storage, and the practical challenges of the energy transition.",
    ...
    },
    {
      ...
      body: [
        "On 25 July 2024, the **Artificial Intelligence Hub (AI-Hub)** of the Electrical and Computer Engineering Department at the **University of Patras** met with the Mayor of Western Achaia, **Grigoris Alexopoulos**, to discuss how artificial intelligence and data-driven tools could support municipal services.",
        "At the time, I was involved in AI-Hub as a **collaborating undergraduate student** of the Department of Electrical and Computer Engineering and Computer Technology. This description follows the official AI-Hub staffing page, where I was listed under collaborating undergraduate students.",
        "The discussion focused on practical use cases where AI could support day-to-day municipal operations, including infrastructure monitoring, water quality, street lighting, and citizen-facing services.",
        "**Application presented:**",
        "• As part of the AI-Hub team, we presented an application for monitoring **pH, temperature, and chlorine levels** in municipal water distribution infrastructure.",
        "• The goal was to transform operational data into clearer indicators, early warnings, and more informed decisions for the people responsible for maintaining the network.",
        "• The application demonstrated how sensing and analytics workflows can support preventive maintenance and improve the reliability of local infrastructure.",
        "**Context:**",
        "• The AI-Hub team included Associate Professors **Kyriakos Sgarbas** and **Epaminondas Mitronikas**, **Fotis Sotiropoulos** from the administrative committee, and undergraduate students **George Sotiropoulos** and myself.",
        "• My role should be described modestly and accurately as a **collaborating undergraduate student** within AI-Hub, not as a lead researcher or staff member.",
      ...
      sources: [
        ...
        { label: "AI-Hub staffing page (Greek)",                   href: "https://sites.google.com/g.upatras.gr/ai-hub/%CE%B4%CE%B9%CE%BF%CE%AF%CE%BA%CE%B7%CF%83%CE%B7/%CF%84%CF%81%CE%AD%CF%87%CE%BF%CF%85%CF%83%CE%B1-%CF%83%CF%84%CE%B5%CE%BB%CE%AD%CF%87%CF%89%CF%83%CE%B7" },
      ],
    },
    {
