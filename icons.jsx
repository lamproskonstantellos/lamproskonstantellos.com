...
const Icon = {
  ...
  brandScopus: (p) => (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" {...p}>
      <rect x="2.5" y="3.5" width="19" height="17" rx="2.5" fill="#E9711C"/>
      <text x="12" y="15.2" textAnchor="middle" fontFamily="Helvetica,Arial,sans-serif" fontSize="9" fontWeight="700" fill="#fff" letterSpacing="0.3">Sc</text>
    </svg>
  ),
  brandGithub: (p) => (
